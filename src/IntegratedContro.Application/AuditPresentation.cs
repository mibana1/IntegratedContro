...
public static class AuditPresentation
{
    public static AuditEntry Enrich(AuditEntry entry, HostState state)
    {
        ...
        var title = entry.Action switch
        {
            ...
            "BackupRequested" => "호스트 백업 요청", "BackupRestored" => "백업 복원",
            ...
            "VirtualStateReconciled" => "가상 상태 대조", "ObservedStateReconciled" => "실제 관측 대조", "DispatchIntent" => "전송 준비",
        ...
        {
            "Simulated" => "가상 실행 완료", "Succeeded" => "명령 처리 종료 · 확인 근거 참조", "Unknown" => "결과 불확실 · 상태 대조 필요",
        ...
        var message = entry.Action switch
        {
            ...
            "ConnectionLost" or "BackupRequested" or "BackupRestored" => entry.Detail,
            ...
            "VirtualDeviceSaved" => $"{deviceName} 설정을 저장했습니다. 설정 버전 {Field("v")}.",
            ...
            "ObservedStateReconciled" => $"{deviceName}의 최신 실제 관측을 대조했습니다. 과거 작업 결과는 변경하지 않았습니다.",
