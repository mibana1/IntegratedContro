...
public sealed partial class ControlService
{
    ...
    {
        var ids = s.Devices.Where(d => _driver.Models.Any(m => m.Id == d.ModelId && m.Category == DeviceCategory.Lighting))
    ...
    private void ValidateCardPower(HostState s, SubmitRequest request, StepSnapshot[] snapshots)
    {
        ...
        Require(request.ScenarioId is null && request.SavedLayoutId is null && request.Operation == DeviceOperation.Power && request.DelayBeforeMs == 0,
