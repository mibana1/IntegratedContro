...
public sealed partial class ControlService
{
    ...
    public LightSlot SaveLightSlot(string token, SaveLightSlotRequest request) => _devices.SaveLightSlot(token, request);
    public LightSlot DeleteLightSlot(string token, DeleteLightSlotRequest request) => _devices.DeleteLightSlot(token, request);
    public Job RestoreLightSlot(string token, RestoreLightSlotRequest request) => _scenarios.RestoreLightSlot(token, request);
