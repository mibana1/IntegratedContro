...
| 목적 | 문서 |
|---|---|
| 설치·초기 설정·변경 복구·데이터 보존의 최신 검증 결과 | [배포 검증 기록](RELEASE_VALIDATION.md) |
| 첫 실행·관리자 접속·호스트 영상 설정 자동 사용·비밀번호 변경/복구·데이터 위치 | [초기 설정 안내](INITIAL_SETUP.md) |
...
설치 위치·바로가기 선택, 설치 후 앱 초기 설정 연결과 설치형 EXE 생성·업데이트·제거는 [설치 배포 안내](INSTALLER.md)를 따른다.
