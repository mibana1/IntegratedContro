...
일반 장비는 **가상 모델**이며 Hiperwall은 실제 Controller와 연동합니다.
...
- Hiperwall 저장 배치 관리·추가 표시와 장비 명령·조건 대기·배치 표시를 연결하는 시나리오

Hiperwall 기본 조회·추가·변경·닫기는 **실제 동작 확인 완료(사용자 확인, 2026-09-14)**입니다.
두 PC·Enterprise·장애 복구·일반 실장비·카메라 영상 연동은 별도 검증 범위입니다.
