...
# FFmpeg remains test-only. stage-mediamtx.ps1 also uses the verified MediaMTX archive, extracting only its executable and license, never the mutable test configuration.
